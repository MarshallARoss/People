...
class CreateFormValidatorTests: XCTestCase {
    ...
    func test_with_empty_first_name_error_thrown() {
        let person = NewPerson(lastName: "Billy", job: "Teacher")
    ...
    func test_with_empty_last_name_error_thrown() {
        let person = NewPerson(firstName: "Joe", job: "Teacher")
    ...
    func test_with_empty_job_error_thrown() {
        let person = NewPerson(firstName: "Billy", lastName: "Joe")
    ...
    func test_with_valid_person_error_not_thrown() {
        let person = NewPerson(firstName: "Joe", lastName: "Billy", job: "Teacher")
        
        do {
            try validator.validate(person)
        } catch {
            XCTFail("No error should be thrown. The person should be a valid object")
        }
    }
